...
# Create a data frame for the Gantt chart
tasks <- data.frame(
  task = c("Task 1", "Task 2", "Task 3", "Task 4"),
  start = as.Date(c("2024-10-01", "2024-10-05", "2024-10-10", "2024-10-15")),
  end = as.Date(c("2024-10-04", "2024-10-07", "2024-10-12", "2024-10-20"))
)

# Create a Gantt chart
ggplot(tasks, aes(x = start, xend = end, y = task)) +
  geom_segment(aes(yend = task), size = 5, color = "skyblue") +
  labs(title = "Project Timeline", x = "Date", y = "Tasks") +
  theme_minimal() +
